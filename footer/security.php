...
<body id="top">
<div class="bgded overlay padtop" style="background-image: url(../images/background/securitybackground.jpg)";>
<header class="hoc clear">
  ...
  <div id="pageintro" class="hoc clear">
    <article> 
      <h3 class="heading" style="text-align: center;">S E C U R I T Y</h3>
       <footer>  
      </footer> 
...
<div class="wrapper row1">
  <section id="ctdetails" class="hoc clear"> 
    ...
    <ul class="nospace clear">
      ...
      <li class="one_quarter">
        <div class="block clear"><a href="map.php"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to </span></div>
      </li>
    </ul>
