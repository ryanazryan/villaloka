...
<body id="top">
<div class="bgded overlay " style="background-image: url(../../images/indonesia/jakarta.jpg);">
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <ul class="nospace clear">
    ...
    <li class="one_quarter">
      <div class="block clear"><a href="https://www.google.com/maps/place/Jakarta/@-6.229728,106.6894291,11z/data=!3m1!4b1!4m5!3m4!1s0x2e69f3e945e34b9d:0x5371bf0fdad786a2!8m2!3d-6.2087634!4d106.845599" target="_blank"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to </span></div>
    </li>
  </ul>
...
<section id="services">
<div class="content"> 
  <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">JAKARTA</h1>
  <br>
<div class="clear"></div>
  <ul class="nospace group grid-3"> 
  <?php
if($kategori_id){
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 1 AND kategori_id ='$kategori_id'");
} else {
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 1");
}
...
?>
        <li class="one_third" style="float: left">
          <article>
            <a><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/indonesialogo.png"; ?>" alt="indonesia"></i></a>  <!-- ukuran foto 1980x1080 -->
