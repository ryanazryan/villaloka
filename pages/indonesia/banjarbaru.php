...
<body id="top">
<div class="bgded overlay " style="background-image: url(../../images/indonesia/banjarbaru.jpg);">
...
<div class="clear"></div>
  ...
  <?php
if($kategori_id){
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 4 AND kategori_id ='$kategori_id'");
} else {
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 4");
}
