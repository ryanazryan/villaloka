...
<body id="top">
<div class="bgded overlay " style="background-image: url(../../images/indonesia/bali.jpg);">
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <ul class="nospace clear">
    ...
    <li class="one_quarter">
      <div class="block clear"><a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJTNqQVxrnRLLpcvmGXszSLxWsbsmSsSxHGVQwrxmrtMrNsdmhzxcSnZsTmDtpSXtFqxVdV" target="_blank"><i class="fas fa-envelope"></i></a> <span><strong>Send us a mail :</strong> villaloka@2022gmail.com</span></div>
    </li>
    <li class="one_quarter">
      <div class="block clear"><a><i class="fas fa-clock"></i></a> <span><strong> Mon. - Sat :</strong> 08.00am - 18.00pm</span></div>
    </li>
    <li class="one_quarter">
      <div class="block clear"><a href="https://www.google.com/maps/place/Bali/@-8.4550726,114.511057,9z/data=!3m1!4b1!4m5!3m4!1s0x2dd141d3e8100fa1:0x24910fb14b24e690!8m2!3d-8.4095178!4d115.188916" target="_blank"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to </span></div>
    </li>
  </ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <section id="services">
    <div class="content"> 
      <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">BALI</h1>
      <br>
    <div class="clear"></div>
...
<?php
if($kategori_id){
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 3 AND kategori_id ='$kategori_id'");
} else {
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 3");
}
...
?>
        <li class="one_third" style="float: left">
          <article><a><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/indonesialogo.png"; ?>" alt="indonesia"></i></a>  <!-- ukuran foto 1980x1080 -->
            ...
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/content/$row[gambar]"; ?>"  style="background-size: cover;">
            <span>Number of Rooms : <?php echo "$row[stok]"?></span>
            <br>
            <footer><a class="btn" style='padding: 4.5px; border-radius: 10px;' href="<?php echo BASE_URL."index.php?page=tambah_keranjang&barang_id=$row[barang_id]"; ?>">Reserve</a></footer>
          </article>
        </li>
