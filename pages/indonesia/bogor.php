...
<body id="top">
<div class="bgded overlay " style="background-image: url(../../images/indonesia/bogor.jpg);">
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <ul class="nospace clear">
    ...
    <li class="one_quarter">
      <div class="block clear"><a href="https://www.google.com/maps/place/Bogor+Regency,+West+Java/@-6.545286,106.5338936,10z/data=!3m1!4b1!4m5!3m4!1s0x2e69c3e312798437:0x301576d14feb990!8m2!3d-6.5517758!4d106.6291304" target="_blank"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to </span></div>
    </li>
  </ul>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <section id="services">
    <div class="content"> 
      <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">BOGOR</h1>
      <br>
    <div class="clear"></div>
  ...
  <?php
if($kategori_id){
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 2 AND kategori_id ='$kategori_id'");
} else {
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 2");
}
