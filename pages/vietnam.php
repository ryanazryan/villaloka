...
<body id="top">
<div class="bgded overlay " style="background-image: url(../images/background/naturebay.jpg);">
...
<p>tận hưởng khoảnh khắc bên nhau và hạnh phúc của bạn với chúng tôi</p>
       <footer>  
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <ul class="nospace clear">
    ...
    <li class="one_quarter">
      <div class="block clear"><a href="https://www.google.com/maps/place/Vietnam/@15.6070734,96.8631597,5z/data=!3m1!4b1!4m5!3m4!1s0x31157a4d736a1e5f:0xb03bb0c9e2fe62be!8m2!3d14.058324!4d108.277199" target="_blank"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to</span></div>
    </li>
  </ul>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">VIETNAM</h1>
    <div class="clear"></div>
  </main>
</div>
  ...
  <main class="hoc container clear"> 
    <section id="services">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <article><a><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/vietnamlogo.png"; ?>" alt="vietnam"></i></a>  <!-- ukuran foto 1980x1080 -->
            <h6 class="heading">HANOI</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/vietnam/hanoi.jpg"; ?>" alt="Candi Prambanan" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/vietnam/hanoi.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/vietnamlogo.png"; ?>" alt="vietnam"></i></a>
            <h6 class="heading">HO CHI MINH CITY</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/vietnam/hochiminhcity.jpg"; ?>" alt="Yen Bai" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/vietnam/hochiminhcity.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/vietnamlogo.png"; ?>" alt="vietnam"></i></a>
            <h6 class="heading">BIEN HOA</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/vietnam/bienhoa.jpg"; ?>" alt="Buckhon Hanok Village" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/vietnam/bienhoa.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/vietnamlogo.png"; ?>" alt="vietnam"></i></a>
            <h6 class="heading">HUE</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/vietnam/hue.jpg"; ?>" alt="Istanbul Turkey" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/vietnam/hue.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/vietnamlogo.png"; ?>" alt="vietnam"></i></a>
            <h6 class="heading">HAIPHONG</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/vietnam/haiphong.jpg"; ?>" alt="China Tower" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/vietnam/haiphong.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/vietnamlogo.png"; ?>" alt="vietnam"></i></a>
            <h6 class="heading">DA NANG</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/vietnam/danang.jpg"; ?>" alt="Paris" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/vietnam/danang.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
      </ul>
    </section>
