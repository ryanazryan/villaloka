...
<body id="top">
<div class="bgded overlay " style="background-image: url(../images/background/fujimountjapan.jpeg);">
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">JAPAN</h1>
    <div class="clear"></div>
  </main>
</div>
  ...
  <main class="hoc container clear"> 
    <section id="services">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <article><a><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/japanlogo.png"; ?>" alt="japan"></i></a>  <!-- ukuran foto 1980x1080 -->
            <h6 class="heading">TOKYO</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/japan/tokyo.jpg"; ?>" alt="Candi Prambanan" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/japan/tokyo.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/japanlogo.png"; ?>" alt="japan"></i></a>
            <h6 class="heading">YOKOHAMA</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/japan/yokohama.jpg"; ?>" alt="Yen Bai" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/japan/yokohama.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/japanlogo.png"; ?>" alt="japan"></i></a>
            <h6 class="heading">OSAKA</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/japan/osaka.jpg"; ?>" alt="Buckhon Hanok Village" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/japan/osaka.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/japanlogo.png"; ?>" alt="japan"></i></a>
            <h6 class="heading">NAGOYA</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/japan/nagoya.jpg"; ?>" alt="japan" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/japan/nagoya.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/japanlogo.png"; ?>" alt="japan"></i></a>
            <h6 class="heading">SAPPORO</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/japan/sapporo.jpg"; ?>" alt="China Tower" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/japan/sapporo.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/japanlogo.png"; ?>" alt="japan"></i></a>
            <h6 class="heading">KOBE</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/japan/kobe.jpg"; ?>" alt="Paris" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/japan/kobe.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
      </ul>
    </section>
