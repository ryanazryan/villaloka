...
<body id="top">
<div class="bgded overlay " style="background-image: url(../images/background/chinesebackground.jpg);">
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <ul class="nospace clear">
    ...
    <li class="one_quarter">
      <div class="block clear"><a href="map.php"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to <a style="color: black;" href="<?php echo BASE_URL."location.php"; ?>" >Your Location</a></span></div>
    </li>
  </ul>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">CHINA</h1>
    <div class="clear"></div>
  </main>
</div>
  ...
  <main class="hoc container clear"> 
    <section id="services">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <article><a><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/chinalogo.png"; ?>" alt="china"></i></a>  <!-- ukuran foto 1980x1080 -->
            <h6 class="heading">BEIJING</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/china/beijing.jpg"; ?>" alt="Candi Prambanan" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/china/beijing.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/chinalogo.png"; ?>" alt="china"></i></a>
            <h6 class="heading">CHONGQING</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/china/chongqing.jpg"; ?>" alt="Yen Bai" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/china/chongqing.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/chinalogo.png"; ?>" alt="china"></i></a>
            <h6 class="heading">GUANGZHOU</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/china/guangzhou.jpg"; ?>" alt="Buckhon Hanok Village" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/china/guangzhou.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/chinalogo.png"; ?>" alt="china"></i></a>
            <h6 class="heading">SHANGHAI</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/china/shanghai.jpg"; ?>" alt="china" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/china/shanghai.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/chinalogo.png"; ?>" alt="china"></i></a>
            <h6 class="heading">SHENZHEN</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/china/shenzhen.jpg"; ?>" alt="China Tower" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/china/shenzhen.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/chinalogo.png"; ?>" alt="china"></i></a>
            <h6 class="heading">TIANJIN</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/china/tianjin.jpg"; ?>" alt="Paris" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/china/tianjin.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
      </ul>
    </section>
