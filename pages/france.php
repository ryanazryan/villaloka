...
<body id="top">
<div class="bgded overlay " style="background-image: url(../images/background/francebackground2.jpg);">
<header class="hoc clear">
  ...
  <div id="pageintro" class="hoc clear">
    <article>
      ...
      <p>Profitez de votre moment de convivialité et de bonheur avec nouss</p>
       <footer>  
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">FRANCE</h1>
    <div class="clear"></div>
  </main>
</div>
