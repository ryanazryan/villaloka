...
<body id="top">
<div class="bgded overlay " style="background-image: url(../images/background/indonesiabackground.jpg);">
<header class="hoc clear">
  ...
  <div id="pageintro" class="hoc clear">
    <article>
      ...
      <p>Nikmati Momen Kebersamaan Dan Kebahagiaan Anda Bersama Kami</p>
       <footer>  
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <ul class="nospace clear">
    ...
    <li class="one_quarter">
      <div class="block clear"><a href="https://www.google.com/maps/place/Indonesia/@-2.3197641,99.4150274,4z/data=!3m1!4b1!4m5!3m4!1s0x2c4c07d7496404b7:0xe37b4de71badf485!8m2!3d-0.789275!4d113.921327" target="_blank"><i class="fas fa-map-marker-alt"></i></a><span><strong>Come visit us :</strong> Directions to </span></div>
    </li>
  </ul>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">INDONESIA</h1>
    <div class="clear"></div>
  </main>
</div>
      ...
      <ul class="nospace group grid-3">
        <li class="one_third">
          <article><a><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/indonesialogo.png"; ?>" alt="indonesia"></i></a>  <!-- ukuran foto 1980x1080 -->
            <h6 class="heading">JAKARTA</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/indonesia/jakarta.jpg"; ?>" alt="Candi Prambanan" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/indonesia/jakarta.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/indonesialogo.png"; ?>" alt="indonesia"></i></a>
            <h6 class="heading">BOGOR</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/indonesia/bogor.jpg"; ?>" alt="Yen Bai" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/indonesia/bogor.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/indonesialogo.png"; ?>" alt="indonesia"></i></a>
            <h6 class="heading">SURABAYA</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/indonesia/surabaya.jpg"; ?>" alt="Buckhon Hanok Village" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/indonesia/surabaya.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/indonesialogo.png"; ?>" alt="indonesia"></i></a>
            <h6 class="heading">MAKASSAR</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/indonesia/makassar.jpg"; ?>" alt="Istanbul Turkey" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/indonesia/makassar.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/indonesialogo.png"; ?>" alt="indonesia"></i></a>
            <h6 class="heading">BALI</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/indonesia/bali.jpg"; ?>" alt="China Tower" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/indonesia/bali.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/indonesialogo.png"; ?>" alt="indonesia"></i></a>
            <h6 class="heading">BANJARBARU</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/indonesia/banjarbaru.jpg"; ?>" alt="Paris" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/indonesia/banjarbaru.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
      </ul>
    </section>
