...
<body id="top">
<div class="bgded overlay " style="background-image: url(../../images/china/shenzhen.jpg);">
...
<div class="wrapper row1">
  <section id="ctdetails" class="hoc clear"> 
    ...
    <ul class="nospace clear">
      ...
      <li class="one_quarter">
        <div class="block clear"><a href="#"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to </span></div>
      </li>
    </ul>
...
<section id="services">
<div class="content"> 
  <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">SHENZHEN</h1>
  <br>
<div class="clear"></div>
  <ul class="nospace group grid-3"> 
<?php
if($kategori_id){
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 33 AND kategori_id ='$kategori_id'");
} else {
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 33");
}
