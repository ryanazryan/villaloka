...
<body id="top">
<div class="bgded overlay " style="background-image: url(../../images/china/tianjin.jpg);">
...
<div class="wrapper row1">
  <section id="ctdetails" class="hoc clear"> 
    ...
    <ul class="nospace clear">
      ...
      <li class="one_quarter">
        <div class="block clear"><a href="https://www.google.com/maps/place/Tianjin,+China/@39.1246963,117.0153401,10z/data=!3m1!4b1!4m5!3m4!1s0x35edfc621e2c0e87:0x847194b730884031!8m2!3d39.085099!4d117.199369" target="_blank"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to </span></div>
      </li>
    </ul>
...
<section id="services">
<div class="content"> 
  <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">TIANJIN</h1>
  <br>
<div class="clear"></div>
  <ul class="nospace group grid-3"> 
<?php
if($kategori_id){
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 36 AND kategori_id ='$kategori_id'");
} else {
  $query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 36");
}
