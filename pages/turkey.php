...
<body id="top">
<div class="bgded overlay " style="background-image: url(../images/background/istanbulsea.jpg);">
<header class="hoc clear">
  ...
  <div id="pageintro" class="hoc clear">
    <article>
      ...
      <p>beraberlik ve mutluluk anınızı bizimle yaşayın</p>
       <footer>  
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <ul class="nospace clear">
    ...
    <li class="one_quarter">
      <div class="block clear"><a href="https://www.google.com/maps/place/Turkey/@38.7407036,26.177382,5z/data=!3m1!4b1!4m5!3m4!1s0x14b0155c964f2671:0x40d9dbd42a625f2a!8m2!3d38.963745!4d35.243322" target="_blank"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to </span></div>
    </li>
  </ul>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">TURKEY</h1>
    <div class="clear"></div>
  </main>
</div>
  ...
  <main class="hoc container clear"> 
    <section id="services">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <article><a><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/turkeylogo.png"; ?>" alt="turkey"></i></a>  <!-- ukuran foto 1980x1080 -->
            <h6 class="heading">ISTANBUL</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/turkey/istanbul.jpg"; ?>" alt="Candi Prambanan" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/turkey/istanbul.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/turkeylogo.png"; ?>" alt="turkey"></i></a>
            <h6 class="heading">BURSA</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/turkey/bursa.jpg"; ?>" alt="Yen Bai" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/turkey/bursa.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/turkeylogo.png"; ?>" alt="turkey"></i></a>
            <h6 class="heading">IZMIR</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/turkey/izmir.jpg"; ?>" alt="Buckhon Hanok Village" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/turkey/izmir.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/turkeylogo.png"; ?>" alt="turkey"></i></a>
            <h6 class="heading">ADANA</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/turkey/adana.jpg"; ?>" alt="Istanbul Turkey" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/turkey/adana.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/turkeylogo.png"; ?>" alt="turkey"></i></a>
            <h6 class="heading">ANKARA</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/turkey/ankara.jpg"; ?>" alt="China Tower" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/turkey/ankara.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/turkeylogo.png"; ?>" alt="turkey"></i></a>
            <h6 class="heading">GAZIANTEP</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/turkey/gaziantep.jpg"; ?>" alt="Paris" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/turkey/gaziantep.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
      </ul>
    </section>
