...
<body id="top">
<div class="bgded overlay " style="background-image: url(../../images/japan/kobe.jpg);">
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <ul class="nospace clear">
    ...
    <li class="one_quarter">
      <div class="block clear"><a href='https://www.google.com/maps/place/Kobe,+Hyogo,+Japan/@34.7574515,134.966985,11z/data=!3m1!4b1!4m5!3m4!1s0x60007d812aed89d9:0xc7126106c2f670f4!8m2!3d34.6900806!4d135.1956311' target='_blank'><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to</span></div>
    </li>
  </ul>
...
<section id="services">
<div class="content"> 
  <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">KOBE</h1>
  <br>
<div class="clear"></div>
...
<?php
if($kategori_id){
$query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 30 AND kategori_id ='$kategori_id'");
} else {
$query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 30");
}
...
?>
        <li class="one_third" style="float: left">
          <article>
            ...
            <h6 class="heading"><a href="<?php echo BASE_URL."index.php?page=barang&barang_id=$row[barang_id]"?>"><?php echo "$row[nama_barang]"?></h6>
