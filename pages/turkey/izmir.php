...
<body id="top">
<div class="bgded overlay " style="background-image: url(../../images/turkey/izmir.jpg);">
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <ul class="nospace clear">
    ...
    <li class="one_quarter">
      <div class="block clear"><a href='https://www.google.com/maps/place/%C4%B0zmir,+Turkey/@38.4175917,26.9396311,11z/data=!3m1!4b1!4m5!3m4!1s0x14bbd862a762cacd:0x628cbba1a59ce8fe!8m2!3d38.423734!4d27.142826' target='_blank'><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to</span></div>
    </li>
  </ul>
...
<section id="services">
<div class="content"> 
  <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">IZMIR</h1>
  <br>
<div class="clear"></div>
...
<?php
if($kategori_id){
$query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 21 AND kategori_id ='$kategori_id'");
} else {
$query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 21");
}
