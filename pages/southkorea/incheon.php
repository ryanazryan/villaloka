...
<body id="top">
<div class="bgded overlay " style="background-image: url(../../images/southkorea/incheon.jpg);">
...
<section id="services">
<div class="content"> 
  <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">INCHEON</h1>
  <br>
<div class="clear"></div>
...
<?php
if($kategori_id){
$query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 17 AND kategori_id ='$kategori_id'");
} else {
$query = mysqli_query($koneksi, "SELECT * FROM barang WHERE status='on' AND subkota_id = 17");
}
