...
<body id="top">
<div class="bgded overlay " style="background-image: url(../images/background/koreanbackground.jpg);">
...
<section id="ctdetails" class="hoc clear"> 
  ...
  <ul class="nospace clear">
    ...
    <li class="one_quarter">
      <div class="block clear"><a href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcSDXmbBCpZLXLbfjzlnQmPgJTjXXNNWMBQzpRJDFDCrhHpQWzhvswjHvnGhFkFqcBmRgktDr" target="_blank"><i class="fas fa-envelope"></i></a> <span><strong>Send us a mail :</strong> villaloka@2022gmail.com</span></div>
    </li>
    <li class="one_quarter">
      <div class="block clear"><a><i class="fas fa-clock"></i></a> <span><strong> Mon. - Sat :</strong> 08.00am - 18.00pm</span></div>
    </li>
    <li class="one_quarter">
      <div class="block clear"><a href="https://www.google.com/maps/place/Japan/@32.1682539,119.0045949,4z/data=!3m1!4b1!4m5!3m4!1s0x34674e0fd77f192f:0xf54275d47c665244!8m2!3d36.204824!4d138.252924" target="_blank"><i class="fas fa-map-marker-alt"></i></a> <span><strong>Come visit us :</strong> Directions to</span></div>
    </li>
  </ul>
  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <h1 style="text-align: center; font-size: 30px; margin-bottom: 30px;">SOUTH KOREA</h1>
    <div class="clear"></div>
  </main>
</div>
  ...
  <main class="hoc container clear"> 
    <section id="services">
      <ul class="nospace group grid-3">
        <li class="one_third">
          <article><a><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/southkorealogo.png"; ?>" alt="southkorea"></i></a>  <!-- ukuran foto 1980x1080 -->
            <h6 class="heading">SEOUL</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/southkorea/seoul.jpg"; ?>" alt="Candi Prambanan" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/southkorea/seoul.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/southkorealogo.png"; ?>" alt="southkorea"></i></a>
            <h6 class="heading">BUSAN</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/southkorea/busan.jpg"; ?>" alt="Yen Bai" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/southkorea/busan.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/southkorealogo.png"; ?>" alt="southkorea"></i></a>
            <h6 class="heading">DAEGU</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/southkorea/daegu.jpg"; ?>" alt="Buckhon Hanok Village" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/southkorea/daegu.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/southkorealogo.png"; ?>" alt="southkorea"></i></a>
            <h6 class="heading">DAEJEON</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/southkorea/daejeon.jpg"; ?>" alt="Istanbul Turkey" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/southkorea/daejeon.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/southkorealogo.png"; ?>" alt="southkorea"></i></a>
            <h6 class="heading">INCHEON</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/southkorea/incheon.jpg"; ?>" alt="China Tower" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/southkorea/incheon.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
        <li class="one_third">
          <article><a href="#"><i style="background: transparent; border: none;"><img src="<?php echo BASE_URL."images/logo/southkorealogo.png"; ?>" alt="southkorea"></i></a>
            <h6 class="heading">JEONJU</h6>
            <img style="aspect-ratio: 1.75" src="<?php echo BASE_URL."images/southkorea/jeonju.jpg"; ?>" alt="Paris" style="background-size: cover;">
            <footer><a href="<?php echo BASE_URL."pages/southkorea/jeonju.php"; ?>">More Details &raquo;</a></footer>
          </article>
        </li>
      </ul>
    </section>
